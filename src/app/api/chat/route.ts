...
export async function POST(request: Request) {
  ...
  return NextResponse.json({
    data: {
      user: { id: userMessage.id, content: userMessage.content, role: 'user', createdAt: userMessage.createdAt },
      bot: { id: botMessage.id, content: botMessage.content, role: 'assistant', createdAt: botMessage.createdAt },
